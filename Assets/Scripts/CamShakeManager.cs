...
public class CamShakeManager : MonoBehaviour {
    ...
    {
        [Tooltip("Initial direction")]
        public float angle;
        [Tooltip("How far the camera moves")]
        public float strength;
        public float maxSpeed;
        public float minSpeed;
        public float duration;
        [Tooltip("Random variation")]
        [Range(0, 1)]
        public float noisePercent;
        [Tooltip("How quickly the strength decreases")]
        [Range(0, 1)]
        public float dampingPercent;
        [Tooltip("How much the movement affects the camera rotation ")]
        [Range(0, 1)]
